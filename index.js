...
const worldCupFinal2014 = fifaData.find(game => game.Year === 2014 && game.Stage === "Final");
...
function getYears(getFinals) {
    return getFinals(fifaData).map(game => game.Year);
};
...
function getWinners(getFinals) {
    return getFinals(fifaData).map(game => {
